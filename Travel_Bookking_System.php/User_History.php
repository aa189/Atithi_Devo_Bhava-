      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span>History</span></p>
      ...
      <div class="container">       
		...
		<div class="col-md-1 pr-md-5"></div>
          <div class="col-md-9 pr-md-5">
			...
			<?php    
			$id=$_SESSION["uid"];
			$result=mysql_query("select * from booking_tb where loginid='$id'",$db);
