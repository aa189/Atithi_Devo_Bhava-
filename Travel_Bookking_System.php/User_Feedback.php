...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	...
	$c=0;
	$id=$_SESSION["uid"];
	$result=mysql_query("select count(fid) from feedback_tb",$db);
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="">Home</a></span> <span>Feedback</span></p>
      ...
      <div class="container">
		...
		<div class="col-md-1 pr-md-5"></div>
          <div class="col-md-6 pr-md-5">
            <form action="User_Feedback_Code.php" method="post">
              <div class="form-group">
                <input type="text" class="form-control" readonly value="<?php echo $c;?>" name="fid">
              </div>
              <div class="form-group">
			   ...
			   <div class="form-group">
                <textarea  cols="30" rows="7" class="form-control" name="feedback" placeholder="Feedback"></textarea>
              </div>
              <div class="form-group">
