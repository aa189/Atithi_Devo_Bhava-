      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Home</a></span> <span>Home</span></p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-9">
			...
			<?php
			$id=$_GET["id"];
			$result=mysql_query("select * from tour_tb where tour_id='$id'",$db);
			while($row=mysql_fetch_array($result))
			{			
			?>
          		<div class="col-md-10 ftco-animate">
		    				<div class="destination">
		    					<a href="Tour_Pic/<?php echo $row[0];?>.jpg" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(Tour_Pic/<?php echo $row[0];?>.jpg);">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="User_Tour_Detail.php?id=<?php echo $row[0];?>"><?php echo $row[1];?></a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
			    						...
			    						<div class="two">
			    							<span class="price per-price"><?php echo $row[3];?>/-</span>
		    							</div>
		    						</div>
		    						...
		    						<p class="bottom-area d-flex"> 
		    							<span class="ml-auto"><a href="User_Booking.php?id=<?php echo $row[0];?>">Book Now</a></span>
		    						</p>
		    					</div>
		    				</div>
		    			</div>
