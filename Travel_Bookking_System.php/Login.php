      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Login Here</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-6 pr-md-5">
			...
			<?php
				if(isset($_GET["msg"]))
				{
					$msg=$_GET["msg"];
					if($msg=="0")
						echo "<span style='color:red'>* Invalid LoginID or Password! Try Again</span>";
				}
			?>
          </div>
        </div>
