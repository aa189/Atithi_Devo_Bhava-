      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="">Home</a></span> <span>Password</span></p>
      ...
      <div class="container">
		...
		<div class="col-md-1 pr-md-5"></div>
          <div class="col-md-6 pr-md-5">
            <form action="User_Change_Pwd_code.php" method="post">
